...
#source("~/3.scripts/main_figures/main_fig.3.R")

#generate_main_fig.3(dataName.list="facs10", filter_rate=0)

# Top4(HDG, HEG, HIPPO, NBDrop)
# Low4(HVG.disp, HVG.vst, NBDisp, M3Drop)

generate_main_fig.3 <- function(dataName.list, filter_rate){
  ####### data loading ################################
